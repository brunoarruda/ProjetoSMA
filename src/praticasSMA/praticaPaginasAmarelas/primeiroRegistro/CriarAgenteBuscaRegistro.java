package praticasSMA.praticaPaginasAmarelas.primeiroRegistro;
...
public class CriarAgenteBuscaRegistro {
    ...
    public static void main(String[] args) throws InterruptedException 
    {
        ...
        addAgent(containerController, "PrestadorServico", AgenteRegistro.class.getName(), null );      
        addAgent(containerController, "AgenteBusca", AgenteBusca.class.getName(), null );      
