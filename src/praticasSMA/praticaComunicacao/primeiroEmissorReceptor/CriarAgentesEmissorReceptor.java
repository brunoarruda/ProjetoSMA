package praticasSMA.praticaComunicacao.primeiroEmissorReceptor;
...
public class CriarAgentesEmissorReceptor {
    ...
    public static void main(String[] args) throws InterruptedException 
    {
        ...
        addAgent(containerController, "Emissor", AgenteEmissor.class.getName(), null );      
        addAgent(containerController, "Receptor", AgenteReceptor.class.getName(), null );
