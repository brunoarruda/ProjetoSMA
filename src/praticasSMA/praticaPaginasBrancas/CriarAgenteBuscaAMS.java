package praticasSMA.praticaPaginasBrancas;
...
public class CriarAgenteBuscaAMS 
{
   ...
   public static void main(String[] args) throws InterruptedException 
   {
      ...
      addAgent(containerController, "BuscaAMS", AgenteBuscaAMS.class.getName(), null );      
