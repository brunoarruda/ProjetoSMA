...
public class CriarAgentesSocorro 
{
    ...
    public static void main(String[] args) throws InterruptedException 
    {
        ...
        addAgent(containerController, "Policial", AgentePolicial.class.getName(), null );
        addAgent(containerController, "Medico", AgenteMedico.class.getName(), null );

        String[] pedidoSocorro = new String[1];
        //pedidoSocorro[0] = "fogo";
        // pedidoSocorro[0] = "ladrao";
        pedidoSocorro[0] = "doente";
        addAgent(containerController, "Solicitante", AgenteSolicitante.class.getName(), pedidoSocorro );
        ...
        addAgent(containerController, "Sniffer", "jade.tools.sniffer.Sniffer", 
           new Object[]{"Solicitante", ";", "Bombeiro", ";", "Policial", ";", "Medico", ";","df"});
    }
