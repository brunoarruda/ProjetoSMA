    ...
    extends Agent
{
    ...
    protected Vector<AID> m_guestList = new Vector<AID>();    // invitees
	...
	PlatformController container = getContainerController(); // get a container controller for creating new agents
		...
		//AgentController guest = container.createNewAgent(localName, "examples.party.GuestAgent", null);
                AgentController guest = container.createNewAgent(localName, GuestAgent.class.getName(), null);
    ...
    protected void endParty() {
        ...
        for (Iterator<AID> i = m_guestList.iterator();  i.hasNext();  ) {
